...
export function Products({ children, products }) {
    ...
    return (
        <section className="w-full p-5 md:max-w-[1200px] max-sm:mb-20 flex flex-col gap-10">
            ...
            <div className="products__container gap-5">
                ...
                {products?.map(product =>
                    <div key={product.id} className="flex flex-col max-w-xl place-content-between p-5 rounded-xl gap-3 shadow-md transition hover:scale-[1.05] bg-white ">
